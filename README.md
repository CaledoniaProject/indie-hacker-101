...
| 供应商      | 初始费用 | 最低续费价格 | 初始服务                                             | 州 |
| ------------- | ----------- | ---------------- | ------------------------------------------------------------ | ----- |
| Stripe Atlas  | $500        | $100             | RA + 注册公司 + EIN + Annual Report + Stripe + Mercury | DE    |
| Firstbase     | $399        | $149             | RA + 注册公司 + EIN + Annual Report + Mercury          | DE/WY |
| WyomingAgents | $154        | $25              | RA + 注册公司 + 年报 + Paid Mailbox           | WY    |
